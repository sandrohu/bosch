        ...
        <div v-if="showExploreDetail" class="full-page-expanded">
          <div class="expanded-card card-explore-expanded">
            ...
            <div class="expanded-content">
              <p class="description">
                博世集团是世界领先的技术及服务供应商。根据初步数据 统计，博世集团约418,000名员工（截至2024年12月 31日），在2024 财政年度创造了903亿欧元的销售额。 博世业务划分为四个领域，涵盖智能出行、工业技术、 消费品以及能源与建筑技术，致力于以科技推动自动化、 电气化、数字化、互联化、可持续等全球趋势发展。凭借 在不同行业和地区的广泛业务布局，博世增强了其业务的 创新性和稳健性。
博世运用其在传感器技术、软件和服务 领域的专知，为客户提供整合式跨领域的解决方案，并利用 在互联技术和人工智能领域的专长，研发生产用户友好 的、可持续的产品。博世在世界范围内践行 “ 科技成就 生活之美” 的承诺，致力于提高人们的生活品质并保护自 然资源。
              </p>
            </div>
...
const allReasons = ref([
  { id: 1, title: '"为生活而发明"理念', description: '博世始终秉持 "Invented for life" 的品牌主张，为人类创造更美好的生活。', logo: getReasonImage(1) },
  { id: 2, title: '全球化布局', description: '博世业务覆盖 60 多个国家，是真正的全球化公司。', logo: getReasonImage(2) },
  { id: 3, title: '中国深耕力度', description: '博世在中国有多年历史，深耕本地市场，致力于本土化发展。', logo: getReasonImage(3) },
  { id: 4, title: '多元业务领域', description: '博世涵盖汽车技术、工业技术、消费品与能源技术等多个业务板块。', logo: getReasonImage(4) },
  { id: 5, title: '可持续发展承诺', description: '博世致力于以可持续科技为核心，推动环保与社会责任。', logo: getReasonImage(5) },
  { id: 6, title: '责任与伦理', description: '在商业决策中坚持责任与伦理，是博世企业文化的基石。', logo: getReasonImage(6) },
  { id: 7, title: '公正与尊重', description: '公正对待员工与合作方，倡导尊重，是博世内在的价值观。', logo: getReasonImage(7) },
  { id: 8, title: '开放与信任', description: '博世鼓励在组织内部建立开放沟通与相互信任的氛围。', logo: getReasonImage(8) },
  { id: 9, title: '主动与担当', description: '每个人都被鼓励主动承担责任、追求目标。', logo: getReasonImage(9) },
  { id: 10, title: '结果导向', description: '博世重视实效，追求行动带来结果与价值。', logo: getReasonImage(10) },
  { id: 11, title: '多样性与包容性', description: '博世重视员工多样性，倡导包容互补的团队文化。', logo: getReasonImage(11) },
  { id: 12, title: '企业传承基因', description: '博世的价值观可追溯至创始人罗伯特·博世的初心。', logo: getReasonImage(12) },
  { id: 13, title: '强大的研发实力', description: '博世在全球拥有大量研发机构，不断投入技术创新。', logo: getReasonImage(13) },
  { id: 14, title: '技术驱动企业', description: '博世的产品与方案背后，都是先进的技术驱动。', logo: getReasonImage(14) },
  { id: 15, title: '智能互联解决方案', description: '博世在物联网、智能互联产品上不断深耕。', logo: getReasonImage(15) },
  { id: 16, title: '汽车事业的核心角色', description: '博世在全球汽车技术领域是关键供应商。', logo: getReasonImage(16) },
  { id: 17, title: '移动出行未来愿景', description: '博世致力于安全、可持续、智能的未来出行解决方案。', logo: getReasonImage(17) },
  { id: 18, title: '工业自动化领先者', description: '博世（例如力士乐部门）在传动与控制技术具领先地位。', logo: getReasonImage(18) },
  { id: 19, title: '家电与消费品链条', description: '博世在家电、厨房、热能设备等消费品领域拥有较高影响力。', logo: getReasonImage(19) },
  { id: 20, title: '节能与环境科技', description: '博世在能源利用、热泵、节能系统等领域持续投入。', logo: getReasonImage(20) },
  { id: 21, title: '智能传感器技术', description: '博世子公司 Sensortec 在 MEMS 传感器方面具影响力。', logo: getReasonImage(21) },
  { id: 22, title: '跨界整合能力', description: '博世能够整合硬件、软件、云服务等跨领域能力。', logo: getReasonImage(22) },
  { id: 23, title: '强大的产业链掌控', description: '从元器件到系统方案，博世在产业链上具备控制能力。', logo: getReasonImage(23) },
  { id: 24, title: '长期视野与投资', description: '博世注重中长期发展而不仅短期利益。', logo: getReasonImage(24) },
  { id: 25, title: '本地化策略', description: '在中国市场，博世注重本地化设计与服务。', logo: getReasonImage(25) },
  { id: 26, title: '创投与未来投入', description: '博世设立创投基金，不断探索未来技术。', logo: getReasonImage(26) },
  { id: 27, title: '科技与社会责任融合', description: '博世强调科技创新必须兼顾社会责任。', logo: getReasonImage(27) },
  { id: 28, title: '慈善实践根植中国', description: '博世在中国有自己的慈善中心，积极参与教育扶贫项目。', logo: getReasonImage(28) },
  { id: 29, title: '员工志愿者文化', description: '博世鼓励员工以志愿者身份参与社会公益。', logo: getReasonImage(29) },
  { id: 30, title: '高度透明的公益机制', description: '在中国的慈善中心强调项目透明性与可持续性。', logo: getReasonImage(30) },
  { id: 31, title: '持续教育投入', description: '博世在教育、人才培养方面持续投入。', logo: getReasonImage(31) },
  { id: 32, title: '因地制宜的公益方案', description: '博世的公益项目结合当地实际需求设计。', logo: getReasonImage(32) },
  { id: 33, title: '本地员工成长机会', description: '本地团队能获得参与全球项目的机会。', logo: getReasonImage(33) },
  { id: 34, title: '跨国导师机制', description: '博世内部可能设有跨国导师或技能传承机制。', logo: getReasonImage(34) },
  { id: 35, title: '技术交流平台', description: '员工可参与跨区域、跨业务的技术交流与分享。', logo: getReasonImage(35) },
  { id: 36, title: '内部创新孵化', description: '博世鼓励内部创新、创业项目孵化。', logo: getReasonImage(36) },
  { id: 37, title: '国际派遣计划', description: '博世提供海外派遣、轮岗机会，让人国际化成长。', logo: getReasonImage(37) },
  { id: 38, title: '多元职业路径', description: '在博世，无论你是技术、管理、市场方向，都有路径。', logo: getReasonImage(38) },
  { id: 39, title: '跨部门协作体验', description: '不同业务线之间协作，为员工提供跨界视角。', logo: getReasonImage(39) },
  { id: 40, title: '系统培训体系', description: '博世通常会提供系统化的入职与在职培训体系。', logo: getReasonImage(40) },
  { id: 41, title: '学习型组织氛围', description: '员工被鼓励不断学习、挑战自我、拥抱新知识。', logo: getReasonImage(41) },
  { id: 42, title: '成果认可机制', description: '优秀成果能得到公司或团队认可、奖励。', logo: getReasonImage(42) },
  { id: 43, title: '创意表达机会', description: '在项目中有机会提出创意、进行实践。', logo: getReasonImage(43) },
  { id: 44, title: '职能轮岗制度', description: '轮岗制度帮助员工拓展视野与能力。', logo: getReasonImage(44) },
  { id: 45, title: '透明的绩效考核', description: '公正、透明的绩效体系让员工清楚自己的定位。', logo: getReasonImage(45) },
  { id: 46, title: '灵活工作机制', description: '在不同岗位可能享有一定的弹性工作制度。', logo: getReasonImage(46) },
  { id: 47, title: '国际文化交流', description: '与来自不同国家同事合作，拓展文化视野。', logo: getReasonImage(47) },
  { id: 48, title: '丰富的内部活动', description: '团队建设、年度活动、兴趣小组丰富员工生活。', logo: getReasonImage(48) },
  { id: 49, title: '健康与福利保障', description: '员工可以享受系统的健康、保险等福利机制。', logo: getReasonImage(49) },
  { id: 50, title: '家庭友好政策', description: '对有家庭责任的员工可能提供亲子支持或弹性安排。', logo: getReasonImage(50) },
  { id: 51, title: '工作环境优越', description: '办公场地、设备通常现代化、舒适。', logo: getReasonImage(51) },
  { id: 52, title: '安全第一思维', description: '在工业、制造、实验环境，博世强调安全标准。', logo: getReasonImage(52) },
  { id: 53, title: '标准化流程', description: '规范流程与制度帮助效率与质量保障。', logo: getReasonImage(53) },
  { id: 54, title: '品牌背书加分', description: '来自博世这个品牌对个人简历也有加分效应。', logo: getReasonImage(54) },
  { id: 55, title: '高质量合作伙伴', description: '与一流高校、企业、研究机构合作，从项目中受益。', logo: getReasonImage(55) },
  { id: 56, title: '参与未来前沿领域', description: '博世在 AI、自动驾驶、能源科技等前沿领域布局。', logo: getReasonImage(56) },
  { id: 57, title: '积极响应全球趋势', description: '博世紧跟工业4.0、绿色发展、数字化趋势。', logo: getReasonImage(57) },
  { id: 58, title: '强大的品牌认知度', description: '博世是公众熟知、值得信赖的高科技品牌。', logo: getReasonImage(58) },
  { id: 59, title: '产品覆盖日常生活', description: '博世产品涉及日常家庭、出行、生活多数场景。', logo: getReasonImage(59) },
  { id: 60, title: '科技与人性结合', description: '博世强调科技应服务于人的幸福，而非冷冰工具。', logo: getReasonImage(60) },
  { id: 61, title: '客户导向文化', description: '博世重视客户反馈，将其视为产品优化关键。', logo: getReasonImage(61) },
  { id: 62, title: '高标准质量管理', description: '在产品和服务上保持高标准的质量认证和控制。', logo: getReasonImage(62) },
  { id: 63, title: '快速响应机制', description: '在市场、客户或技术变化中，博世具备快速响应能力。', logo: getReasonImage(63) },
  { id: 64, title: '持续改进文化', description: '不断反思、优化、精进，是博世文化的一部分。', logo: getReasonImage(64) },
  { id: 65, title: '跨文化团队合作', description: '国际团队协作让你习得跨文化沟通能力。', logo: getReasonImage(65) },
  { id: 66, title: '职业稳定性', description: '在大企业体系下，具有相对稳定的职业保障。', logo: getReasonImage(66) },
  { id: 67, title: '与行业顶尖竞争', description: '博世经常参与或引领行业技术标准与竞争。', logo: getReasonImage(67) },
  { id: 68, title: '可见的社会影响力', description: '博世的很多产品与项目直接影响社会发展。', logo: getReasonImage(68) },
  { id: 69, title: '实践可持续技术项目', description: '你可能参与减碳、能源效率提升等项目。', logo: getReasonImage(69) },
  { id: 70, title: '长寿命产品价值观', description: '博世的产品设计注重耐用性与可维护性。', logo: getReasonImage(70) },
  { id: 71, title: '本地化制造能力', description: '在中国设有生产基地，更贴近市场与用户。', logo: getReasonImage(71) },
  { id: 72, title: '全球采购网络', description: '博世具备全球采购与供应链能力，资源整合强。', logo: getReasonImage(72) },
  { id: 73, title: '绿色制造推进', description: '制造过程中推行节能减排与绿色标准。', logo: getReasonImage(73) },
  { id: 74, title: '智能制造与自动化', description: '博世内部也在使用智能制造技术进行自我升级。', logo: getReasonImage(74) },
  { id: 75, title: '工业 4.0 实践者', description: '在智能工厂、数字化车间上有真实落地经验。', logo: getReasonImage(75) },
  { id: 76, title: '精益生产理念', description: '博世推行精益、六西格玛等管理理念以提升效率。', logo: getReasonImage(76) },
  { id: 77, title: '客户定制化能力', description: '能为客户提供定制化方案，而非一刀切产品。', logo: getReasonImage(77) },
  { id: 78, title: '开放平台生态', description: '在 IoT、平台生态上愿与合作伙伴共建。', logo: getReasonImage(78) },
  { id: 79, title: '强调知识产权', description: '在专利、技术保护方面严格，尊重创新。', logo: getReasonImage(79) },
  { id: 80, title: '国际项目经验积累', description: '能参与跨国项目，获得国际视野。', logo: getReasonImage(80) },
  { id: 81, title: '员工荣誉传承', description: '博世内部有优秀员工、团队表彰机制。', logo: getReasonImage(81) },
  { id: 82, title: '成就感可视化', description: '项目成果直观可见，可以看到"自己做的东西在世界上被用到"。', logo: getReasonImage(82) },
  { id: 83, title: '参与标准制定', description: '在行业标准、技术标准制定中有代表性声音。', logo: getReasonImage(83) },
  { id: 84, title: '行业先锋角色', description: '在许多业务领域，博世都是技术与市场的先锋。', logo: getReasonImage(84) },
  { id: 85, title: '自主决策空间', description: '虽在大公司架构中，仍赋予项目或团队一定自主权。', logo: getReasonImage(85) },
  { id: 86, title: '透明晋升通道', description: '晋升、发展路径在公司内部较为透明。', logo: getReasonImage(86) },
  { id: 87, title: '国际交流机会', description: '有机会到德国或其他国家交流、学习。', logo: getReasonImage(87) },
  { id: 88, title: '多语种环境', description: '英语、德语或其他语种成为工作环境的一部分。', logo: getReasonImage(88) },
  { id: 89, title: '高标准安全保障', description: '企业对员工的安全保护制度严格，减少风险。', logo: getReasonImage(89) },
  { id: 90, title: '品牌自豪感', description: '身为博世人，背后有强大品牌支持与认同感。', logo: getReasonImage(90) },
  { id: 91, title: '公信力企业形象', description: '博世在大众、行业中具有良好口碑与信任度。', logo: getReasonImage(91) },
  { id: 92, title: '营造创新文化', description: '鼓励试错、创新，让员工敢于挑战。', logo: getReasonImage(92) },
  { id: 93, title: '多学科交叉机会', description: '你可能跨机械、电子、软件、控制等多个学科协作。', logo: getReasonImage(93) },
  { id: 94, title: '国际化视野塑造', description: '在博世工作自然塑造你具备国际化思维。', logo: getReasonImage(94) },
  { id: 95, title: '全球客户互动', description: '与全球客户、合作伙伴互动交流经验。', logo: getReasonImage(95) },
  { id: 96, title: '卓越科技影响力', description: '博世的科技、解决方案在世界许多地方落地。', logo: getReasonImage(96) },
  { id: 97, title: '面向未来的业务布局', description: '博世在新能源、自动驾驶、智慧家居等未来方向持续投入。', logo: getReasonImage(97) },
  { id: 98, title: '长期信任背后资本结构', description: '博世大部分股份由基金会持有，以社会责任为导向。', logo: getReasonImage(98) },
  { id: 99, title: '历史底蕴与品牌传承', description: '博世有悠久历史，从 1886 年创业至今，是百年科技公司。', logo: getReasonImage(99) },
  { id: 100, title: '与优秀人为伍', description: '在博世，你将与国内外顶尖人才合作、成长、成就未来。', logo: getReasonImage(100) }
])
